...
const descriptions = {
  ru: {
    ...
    devices: 'Агенты и подключенные устройства',
    amneziawg: 'AmneziaWG обфусцированный туннель и пиры',
  ...
  en: {
    ...
    rpz: 'DNS Response Policy Zone',
    devices: 'Agents and connected devices',
    amneziawg: 'AmneziaWG obfuscated tunnel and peers',
