...
const ENV_ORDER = [
  ...
  'REVERSE_PROXY_UPSTREAM', 'OIDC_PROVIDERS', 'OIDC_REDIRECT_BASE', 'OIDC_SESSION_TTL_SECONDS',
  'OIDC_GOOGLE_CLIENT_ID', 'OIDC_GOOGLE_CLIENT_SECRET', 'OIDC_GOOGLE_ALLOWED_DOMAINS',
  'OIDC_APPLE_CLIENT_ID', 'OIDC_APPLE_TEAM_ID', 'OIDC_APPLE_KEY_ID', 'OIDC_APPLE_PRIVATE_KEY_FILE',
  'OIDC_CORP_CLIENT_ID', 'OIDC_CORP_CLIENT_SECRET', 'OIDC_CORP_ISSUER_URL', 'OIDC_CORP_REDIRECT_URI',
