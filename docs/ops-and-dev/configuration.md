...
- контроль latency ClickHouse: `ALERT_CLICKHOUSE_TIMEOUT_MS` (15000),
  `ALERT_CLICKHOUSE_MAX_EXECUTION_SECS`, `ALERT_CLICKHOUSE_MAX_RESULT_ROWS` (50000),
  `ALERT_CLICKHOUSE_SLOW_QUERY_MS` (2000), `ALERT_CLICKHOUSE_FAILURE_THRESHOLD` (3),
  `ALERT_CLICKHOUSE_BACKOFF_MAX_SECS` (300), `ALERT_CLICKHOUSE_QUERY_GUARDS` (`true`).
