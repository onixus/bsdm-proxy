...
| Agent (Phase C) | Local policy agent spike | Beta (lab) | Enroll, CSR, events, **policy push** (watch/SSE), optional control mTLS. Multi-OS / CRL reserved. [pilot-agent.md](getting-started/pilot-agent.md). |
