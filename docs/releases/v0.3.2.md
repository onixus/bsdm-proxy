...
> **Superseded by [v0.5.0](v0.5.0.md)** for threat analytics / alerting. Still valid for M2.5 perf baseline.
...
See [docs/performance.md](../architecture/performance.md). **Do not enable `PERF_FAST_CACHE_HIT` in production with ACL enabled.**
...
See [docs/categorization.md](../features/categorization.md).
