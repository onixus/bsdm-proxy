...
Optional sidecars: compose profiles `icap`, `dns-sinkhole`, `ml`, `alerts` — см. [docker.md](../getting-started/deployment.md).
...
- [dns-sinkhole.md](../features/dns-sinkhole.md) · [icap.md](../features/icap-inspection.md) · [wasm-plugins.md](../features/wasm-plugins.md)
