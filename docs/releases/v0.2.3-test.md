...
> **Superseded by [v0.3.1](v0.3.1.md)** — для production используйте 0.3.1 (ClickHouse analytics). M2 features: [v0.3.0](v0.3.0.md).
...
> Актуальные ограничения см. в [v0.3.1](v0.3.1.md).
