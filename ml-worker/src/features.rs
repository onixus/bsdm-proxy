...
impl EntityFeatures {
    pub fn to_insert_json(&self) -> serde_json::Value {
        serde_json::json!({
            ...
            "job_search_count": self.job_search_count,
...
SELECT
  ...
  countIf(hasAny(categories, ['JobSearch', 'Careers', 'Recruitment'])) AS job_search_count,
...
pub fn features_from_row(
    ...
    Ok(EntityFeatures {
        ...
        job_search_count: as_u64(row.get("job_search_count")).unwrap_or(0),
